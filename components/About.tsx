...
<div className="lg:col-span-7 space-y-4 text-left order-1 flex flex-col justify-center items-start py-2">
  ...
  {/* ✅ Main H2 Section Title: Shifted to direct target look, blueprint size standard & ultra-heavy font-sans weight */}
  <m.h2 
  ...
  >
    The Property Strategist <br />
    <span className="text-[#C9A050]">Aesthetic Intelligence.</span>
  </m.h2>
  
  {/* ✅ Description Box: Locked at pure white and strict 15px mobile response standard layout */}
  <div className="space-y-4 text-[15px] sm:text-[16px] md:text-[17px] text-white font-sans font-normal leading-relaxed tracking-wide max-w-xl">
    <m.p 
      initial={isMobile ? { opacity: 1 } : { opacity: 0 }}
      whileInView={{ opacity: 1 }}
      viewport={{ once: true, margin: "-100px" }}
