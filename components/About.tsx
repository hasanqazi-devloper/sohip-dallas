    ...
    <section id="about" className="py-20 md:py-32 bg-[#121212] border-t border-white/5 scroll-mt-24 relative z-10">
      <div className="max-w-[1200px] mx-auto px-6 md:px-24 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left order-1">
          {/* Mobile par duration aur animation instantaneous (0.3s) kar di hai with once view layout mapping */}
          <m.span 
            initial={{ opacity: 0 }}
        ...
        {/* ✅ Mobile GPU and hardware transformation optimization applied */}
        <m.div 
        ...
        >
          ...
          <img 
            ...
            className="w-full h-full object-cover brightness-95 object-center group-hover:scale-102 transition-transform duration-700" 
            loading="lazy"
            decoding="async"
